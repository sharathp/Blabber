...
public class ImageUtils {
    private static final int PROFILE_TRANSFORM_RADIUS = 5;
    ...
    public static void loadProfileImage(final Context context, final ImageView imageView, final String url) {
        Glide.with(context)
